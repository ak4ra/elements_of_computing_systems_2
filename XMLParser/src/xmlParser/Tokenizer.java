...
import xmlParser.enums.TokenType;
...
public class Tokenizer {
    ...
    private String currentCharToString;
    ...
    public void tokenize() {
        ...
        try {
            ...
            if (currentChar != -1) {
                ...
                currentCharToString = Character.toString(currentChar);
            } else {
            ...
            if (Character.isWhitespace(currentChar)) {
            ...
            } else if (currentCharToString.equals("/")) {
                ...
                if (Character.toString(nextChar).equals("/")) {
                ...
                } else if (Character.toString(nextChar).equals("*")) {
                    ...
                    do {
                        ...
                        nextChar = bufferedReader.read();
                            ...
                            && Character.toString(nextChar).equals("/")));
            ...
            } else if (Arrays.stream(symbols).anyMatch(currentCharToString::equals)) {
                ...
                while (!Character.toString(nextChar).equals("\"")) {
            ...
            } else if (Character.isAlphabetic(currentChar) || currentCharToString.equals("_")) {
                ...
                do {
                    ...
                    currentChar = bufferedReader.read();
                        ...
                        || Character.toString(currentChar).equals("_"));
