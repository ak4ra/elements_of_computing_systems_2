...
import nand2tetris.compiler.enums.DeclarationOrUse;
import nand2tetris.compiler.enums.IdentifierKind;

import java.util.HashMap;
import java.util.LinkedHashMap;
import java.util.Random;

import static nand2tetris.compiler.enums.TokenType.*;
    ...
    public void compileSubroutine() {
        ...
        if (currentSubroutineDeclarationKind.equals("method")) {
            ...
            vmWriter.writePush("constant",
                    (symbolTable.varCount(IdentifierKind.STATIC) + symbolTable.varCount(IdentifierKind.FIELD)));
